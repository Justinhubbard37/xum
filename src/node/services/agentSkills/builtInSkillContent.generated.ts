...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "xum-docs": {
    ...
    "references/docs/agents/index.mdx": [
      ...
      "## Quick Start",
      "",
      "Drop a Markdown file in `.mux/agents/` (project) or `~/.xum/agents/` (global):",
      "",
      "```md",
      "---",
      "name: Review",
    ...
    "references/docs/agents/instruction-files.mdx": [
      ...
      "  to the agent. Move any `## Model: ...` sections into `.mux/AGENTS.md` (or `~/.xum/AGENTS.md`). See",
      ...
      "  workspace `.mux/AGENTS.md` → global `~/.xum/AGENTS.md`.",
      ...
      "  Move `## Model: ...` sections to `.mux/AGENTS.md` (or `~/.xum/AGENTS.md`).",
      "</Warning>",
      "",
      "`Model:` is honored only in Xum-dedicated sources: agent definitions, `.mux/AGENTS.md` files, and",
      "`~/.xum/AGENTS.md`.",
      "",
      "**Syntax**: `Model: <regex>`",
      "",
      ...
      "",
      "**Example** (in `.mux/AGENTS.md` or `~/.xum/AGENTS.md`):",
      "",
      "```markdown",
      "## Model: sonnet",
      "",
      ...
      "`<mode-...>` tag.",
      "",
      "`Mode:` is honored only in Xum-dedicated sources: agent definitions, `.mux/AGENTS.md` files, and",
      "`~/.xum/AGENTS.md`.",
      "",
      "**Syntax**: `Mode: <mode>`",
      "",
    ...
    "references/docs/agents/plan-mode.mdx": [
      ...
      "agent behaves in plan mode. Add the following to `.mux/AGENTS.md` (or `~/.xum/AGENTS.md`):",
      "",
      "```markdown",
      "## Mode: Plan",
      "",
    ...
    "references/docs/workspaces/compaction/customization.mdx": [
      ...
      "",
      "Create `.mux/agents/compact.md` in your project (or `~/.xum/agents/compact.md` for global):",
      "",
      "```md",
      "---",
      "name: Compact",
