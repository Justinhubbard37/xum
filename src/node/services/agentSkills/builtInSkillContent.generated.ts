...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "xum-docs": {
    ...
    "references/docs/agents/instruction-files.mdx": [
      ...
      "",
      "1. `~/.xum/AGENTS.md` — global defaults (Xum-dedicated by construction)",
      "2. Workspace root — shared file + `<workspace>/.xum/AGENTS.md`",
      "3. Sub-project and each repo directory in multi-project workspaces — shared file + `.xum/AGENTS.md`",
      "",
      "<Info>",
      ...
      "```",
      "~/.xum/",
      "  AGENTS.md          # Global instructions (Xum-dedicated)",
